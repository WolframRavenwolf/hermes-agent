...
def init_agent(
    ...
    if fallback_service_tier_override is not None and not agent._fallback_activated:
        # This policy belongs to the manually selected primary route, not to a
        # different entry already activated by native setup fallback above.
