...
def _restart_launchd_gateway_after_update(*, supervision_verify: bool = True) -> tuple[list, list]:
    ...
    success requires a fresh supervised PID or this invocation's successful native fallback.
    ...
    try:
        ...
        detached_started = launchd_restart() is True
    ...
    # This invocation can confirm a fresh native fallback without trusting old markers.
    if not supervision_verify or detached_started:
        return [current_label], []
