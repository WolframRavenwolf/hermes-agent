...
class TestVerboseCommand:
    ...
    async def test_cycles_through_all_modes(self, tmp_path, monkeypatch):
        ...
        # off -> new -> all -> verbose -> full -> log -> off
        expected = ["new", "all", "verbose", "full", "log", "off"]
    ...
    def test_full_is_a_valid_per_platform_tool_progress_mode(self):
        from gateway.display_config import resolve_display_setting

        config = {
            "display": {"platforms": {"telegram": {"tool_progress": "FULL"}}}
        }
