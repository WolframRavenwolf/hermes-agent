...
@pytest.mark.asyncio
async def test_status_command_uses_most_recent_persisted_model_route(tmp_path, monkeypatch, status_metadata_lookup):
    ...
    try:
        ...
        status_metadata_lookup.assert_awaited_once_with(
            "upstage/solar-pro4:free", provider="nous",
            base_url="https://inference-api.nousresearch.com/v1/", api_key="",
...
@pytest.mark.asyncio
async def test_status_command_prefers_rehydrated_session_model_override(tmp_path, status_metadata_lookup):
    ...
    try:
        ...
        status_metadata_lookup.assert_awaited_once_with(
            "model-b", provider="provider-b", base_url="https://b.example/v1", api_key="",
            config_context_length=None, custom_providers=None,
        )
    finally:
        db.close()
